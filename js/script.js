	...
	this.blocks = [];
	sprites.push(jogador);
//	img,posX, posY, width, height, color
	var paredecima = new Sprite(0,0, 0, 800, 15, "#000000");
	sprites.push(paredecima);
	blocks.push(paredecima);
	var gameworld = {
		img:scene,
		x: 0,
		y: 0,
